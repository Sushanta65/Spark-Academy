...
const PopularClasses = () => {
  ...
  useEffect(() => {
    axiosPublic.get("/teacher-classes").then((res) => {
      const popularClasses = res.data.sort((a, b) => b.enrolled - a.enrolled);
      setClasses(popularClasses.slice(0, 6));
    });
  }, [axiosPublic]);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center pb-20">
          <div className="">
            ...
            <p className="my-4">Find out which courses are gaining the most attention and enrollment from students.</p>
